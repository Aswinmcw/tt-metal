...
int main(int argc, char** argv) {
    ...
    try {
        ...
        auto in0_buffer = CreateBuffer(device, in0_buffer_size, single_tile_size, in0_buffer_type);
        auto in1_buffer = CreateBuffer(device, in1_buffer_size, single_tile_size, in1_buffer_type);
        auto out_buffer = CreateBuffer(device, out_buffer_size, single_tile_size, out_buffer_type);
