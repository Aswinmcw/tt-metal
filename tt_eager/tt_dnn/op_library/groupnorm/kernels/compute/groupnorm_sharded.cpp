...
void MAIN {
    ...
    UNPACK (( DPRINT << "per_core_M " << per_core_M << ENDL() ));
    ...
    UNPACK (( DPRINT << "block_bhw " << block_bhw << ENDL() ));
    ...
    UNPACK (( DPRINT << "cb_in " << ENDL() ));
    UNPACK (( DPRINT << TSLICE(cb_in, 0, SliceRange::h0_w0_32()) << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_in, 1, SliceRange::h0_w0_32()) << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_in, 2, SliceRange::h0_w0_32()) << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_in, 3, SliceRange::h0_w0_32()) << ENDL() ));
    ...
    cb_wait_front(cb_ex_partial, num_batch_group);
    // UNPACK (( DPRINT << "mean " << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_ex_partial, 0, SliceRange::h0_w0_32()) << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_ex_partial, 1, SliceRange::h0_w0_32()) << ENDL() ));
    ...
    UNPACK (( DPRINT << "mean  " << ENDL() ));
    UNPACK (( DPRINT << TSLICE(cb_ex_global, 0, SliceRange::h0_w0_32()) << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_ex_global, 1, SliceRange::h0_w0_32()) << ENDL() ));
    ...
    //         // PACK (( DPRINT << "cb_ex2pe done !!! " << ENDL() ));

    // UNPACK (( DPRINT << "inv_sqrt " << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_ex2pe, 0, SliceRange::h0_w0_32()) << ENDL() ));
    // UNPACK (( DPRINT << TSLICE(cb_ex2pe, 1, SliceRange::h0_w0_32()) << ENDL() ));
