...
namespace tt::tt_metal::detail{
    ...
    m_tensor.def("pow", py::overload_cast<const Tensor&, int, const MemoryConfig&>(&tt::tt_metal::pow),
        ...
        detail::bind_unary_op_with_param(
            ...
            py::arg("dim"),
            R"doc(Returns the indices of the maximum value of all elements in the ``input`` tensor.)doc",
            R"doc("dim", "int", "")doc"
        );
        ...
        detail::bind_unary_op_with_param(
            ...
            py::arg("dim"),
            R"doc(Returns the indices of the minimum value of all elements in the ``input`` tensor.)doc",
            R"doc("dim", "int", "")doc"
        );
