...
constexpr static std::uint32_t PROFILER_L1_CONTROL_VECTOR_SIZE = 12;
...
constexpr static std::uint32_t PROFILER_FULL_HOST_VECTOR_SIZE_PER_RISC = PROFILER_L1_MARKER_UINT32_SIZE * PROFILER_L1_GUARANTEED_MARKER_COUNT * PROFILER_OP_SUPPORT_COUNT;
...
constexpr static std::uint32_t PROFILER_FULL_HOST_BUFFER_SIZE = PROFILER_RISC_COUNT * PROFILER_CORE_COUNT * PROFILER_FULL_HOST_BUFFER_SIZE_PER_RISC;
constexpr static std::uint32_t PROFILER_FULL_HOST_BUFFER_SIZE_PER_DRAM_BANK = PROFILER_FULL_HOST_BUFFER_SIZE / PROFILER_DRAM_BANK_COUNT;

constexpr static std::uint32_t PROFILER_HOST_BUFFER_SIZE = PROFILER_L1_BUFFER_SIZE * PROFILER_RISC_COUNT * PROFILER_CORE_COUNT;
