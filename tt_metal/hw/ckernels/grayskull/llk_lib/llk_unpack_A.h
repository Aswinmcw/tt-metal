...
template <BroadcastType BType = BroadcastType::NONE, bool acc_to_dest = false, EltwiseBinaryReuseDestType binary_reuse_dest = EltwiseBinaryReuseDestType::NONE>
inline void _llk_unpack_A_block_(const std::uint32_t start_tile_index, const std::uint32_t ntiles, const std::uint32_t base_address, const std::uint32_t offset_address, const int transpose_of_faces = 0) {
